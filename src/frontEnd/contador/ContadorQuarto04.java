...
import javax.swing.JLabel;  
    ...
    public class ContadorQuarto04 extends Thread {  
      
        private JLabel hr;  
      
        public ContadorQuarto04(JLabel hora) {  
            this.hr = hora;  
        }  
        ...
        public void run() {  
           try {  
               ...
               while( true ) {  
                   Thread.sleep(1000);  
                   if( GuiCronometroQuarto04.isContador() ) {  
                       if( GuiCronometroQuarto04.isZerado() ) {  
                           segundo = 0;  
                           hora = 0;  
                           minuto = 0;  
                           GuiCronometroQuarto04.setZerado(false);  
                       }  
                       segundo++;  
