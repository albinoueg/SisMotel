...
import javax.swing.JLabel;  
    ...
    public class ContadorQuarto11 extends Thread {  
      
        private JLabel hr;  
      
        public ContadorQuarto11(JLabel hora) {  
            this.hr = hora;  
        }  
        ...
        public void run() {  
           try {  
               ...
               while( true ) {  
                   Thread.sleep(1000);  
                   if( GuiCronometroQuarto11.isContador() ) {  
                       if( GuiCronometroQuarto11.isZerado() ) {  
                           segundo = 0;  
                           hora = 0;  
                           minuto = 0;  
                           GuiCronometroQuarto11.setZerado(false);  
                       }  
                       segundo++;  
