...
import javax.swing.JLabel;  
    ...
    public class ContadorQuarto02 extends Thread {  
      
        private JLabel hr;  
      
        public ContadorQuarto02(JLabel hora) {  
            this.hr = hora;  
        }  
        ...
        public void run() {  
           try {  
               ...
               while( true ) {  
                   Thread.sleep(1000);  
                   if( GuiCronometroQuarto02.isContador() ) {  
                       if( GuiCronometroQuarto02.isZerado() ) {  
                           segundo = 0;  
                           hora = 0;  
                           minuto = 0;  
                           GuiCronometroQuarto02.setZerado(false);  
                       }  
                       segundo++;  
