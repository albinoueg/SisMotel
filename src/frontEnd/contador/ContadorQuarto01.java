...
import javax.swing.JLabel;  
    ...
    public class ContadorQuarto01 extends Thread {  
      
        private JLabel hr;  
      
        public ContadorQuarto01(JLabel hora) {  
            this.hr = hora;  
        }  
        ...
        public void run() {  
           try {  
               ...
               while( true ) {  
                   Thread.sleep(1000);  
                   if( GuiCronometroQuarto01.isContador() ) {  
                       if( GuiCronometroQuarto01.isZerado() ) {  
                           segundo = 0;  
                           hora = 0;  
                           minuto = 0;  
                           GuiCronometroQuarto01.setZerado(false);  
                       }  
                       segundo++;  
