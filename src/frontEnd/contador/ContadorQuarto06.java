...
import javax.swing.JLabel;  
    ...
    public class ContadorQuarto06 extends Thread {  
      
        private JLabel hr;  
      
        public ContadorQuarto06(JLabel hora) {  
            this.hr = hora;  
        }  
        ...
        public void run() {  
           try {  
               ...
               while( true ) {  
                   Thread.sleep(1000);  
                   if( GuiCronometroQuarto06.isContador() ) {  
                       if( GuiCronometroQuarto06.isZerado() ) {  
                           segundo = 0;  
                           hora = 0;  
                           minuto = 0;  
                           GuiCronometroQuarto06.setZerado(false);  
                       }  
                       segundo++;  
