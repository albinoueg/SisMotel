...
import javax.swing.JLabel;  
    ...
    public class ContadorQuarto05 extends Thread {  
      
        private JLabel hr;  
      
        public ContadorQuarto05(JLabel hora) {  
            this.hr = hora;  
        }  
        ...
        public void run() {  
           try {  
               ...
               while( true ) {  
                   Thread.sleep(1000);  
                   if( GuiCronometroQuarto05.isContador() ) {  
                       if( GuiCronometroQuarto05.isZerado() ) {  
                           segundo = 0;  
                           hora = 0;  
                           minuto = 0;  
                           GuiCronometroQuarto05.setZerado(false);  
                       }  
                       segundo++;  
