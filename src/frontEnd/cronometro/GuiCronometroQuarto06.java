...
import frontEnd.contador.ContadorQuarto06;
...
public class GuiCronometroQuarto06 extends javax.swing.JFrame {
    ...
    public GuiCronometroQuarto06() {
        initComponents();
        ContadorQuarto06 cont = new ContadorQuarto06(lConta);  
        cont.start(); 
        try {
            geraLista();
        } catch (SQLException ex) {
            Logger.getLogger(GuiCronometroQuarto06.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void iniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iniciarActionPerformed
        ...
        GuiVendas.btQuarto06.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa vermelha.png")));
    ...
    private void pausarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pausarActionPerformed
        ...
        GuiVendas.btQuarto06.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa amarela.png")));
    ...
    private void zerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerarActionPerformed
        ...
        iniciar.setEnabled(true);  
        pausar.setEnabled(false); 
        GuiVendas.btQuarto06.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa verde.png")));
        ...
        GuiCronometroQuarto06.this.dispose();
