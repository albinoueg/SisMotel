...
import frontEnd.contador.ContadorQuarto10;
...
public class GuiCronometroQuarto10 extends javax.swing.JFrame {
    ...
    public GuiCronometroQuarto10() {
        initComponents();
        ContadorQuarto10 cont = new ContadorQuarto10(lConta);  
        cont.start(); 
        try {
            geraLista();
        } catch (SQLException ex) {
            Logger.getLogger(GuiCronometroQuarto10.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void iniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iniciarActionPerformed
        ...
        GuiVendas.btQuarto10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa vermelha.png")));
    ...
    private void pausarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pausarActionPerformed
        ...
        GuiVendas.btQuarto10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa amarela.png")));
    ...
    private void zerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerarActionPerformed
        ...
        iniciar.setEnabled(true);  
        pausar.setEnabled(false); 
        GuiVendas.btQuarto10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa verde.png")));
        ...
        GuiCronometroQuarto10.this.dispose();
