...
import frontEnd.contador.ContadorQuarto05;
...
public class GuiCronometroQuarto05 extends javax.swing.JFrame {
    ...
    public GuiCronometroQuarto05() {
        initComponents();
        ContadorQuarto05 cont = new ContadorQuarto05(lConta);  
        cont.start(); 
        try {
            geraLista();
        } catch (SQLException ex) {
            Logger.getLogger(GuiCronometroQuarto05.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void iniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iniciarActionPerformed
        ...
        GuiVendas.btQuarto05.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa vermelha.png")));
    ...
    private void pausarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pausarActionPerformed
        ...
        GuiVendas.btQuarto05.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa amarela.png")));
    ...
    private void zerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerarActionPerformed
        ...
        iniciar.setEnabled(true);  
        pausar.setEnabled(false); 
        GuiVendas.btQuarto05.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa verde.png")));
        ...
        GuiCronometroQuarto05.this.dispose();
