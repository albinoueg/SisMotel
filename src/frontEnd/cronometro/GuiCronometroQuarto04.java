...
import frontEnd.contador.ContadorQuarto04;
...
public class GuiCronometroQuarto04 extends javax.swing.JFrame {
    ...
    public GuiCronometroQuarto04() {
        initComponents();
        ContadorQuarto04 cont = new ContadorQuarto04(lConta);  
        cont.start(); 
        try {
            geraLista();
        } catch (SQLException ex) {
            Logger.getLogger(GuiCronometroQuarto04.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void iniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iniciarActionPerformed
        ...
        GuiVendas.btQuarto04.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa vermelha.png")));
    ...
    private void pausarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pausarActionPerformed
        ...
        GuiVendas.btQuarto04.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa amarela.png")));
    ...
    private void zerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerarActionPerformed
        ...
        iniciar.setEnabled(true);  
        pausar.setEnabled(false); 
        GuiVendas.btQuarto04.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa verde.png")));
        ...
        GuiCronometroQuarto04.this.dispose();
