...
import frontEnd.contador.ContadorQuarto09;
...
public class GuiCronometroQuarto09 extends javax.swing.JFrame {
    ...
    public GuiCronometroQuarto09() {
        initComponents();
        ContadorQuarto09 cont = new ContadorQuarto09(lConta);  
        cont.start(); 
        try {
            geraLista();
        } catch (SQLException ex) {
            Logger.getLogger(GuiCronometroQuarto09.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void iniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iniciarActionPerformed
        ...
        GuiVendas.btQuarto09.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa vermelha.png")));
    ...
    private void pausarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pausarActionPerformed
        ...
        GuiVendas.btQuarto09.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa amarela.png")));
    ...
    private void zerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zerarActionPerformed
        ...
        iniciar.setEnabled(true);  
        pausar.setEnabled(false); 
        GuiVendas.btQuarto09.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Casa verde.png")));
        ...
        GuiCronometroQuarto09.this.dispose();
