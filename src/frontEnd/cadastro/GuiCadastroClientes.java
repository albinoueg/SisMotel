...
public class GuiCadastroClientes extends JDialog {

    Dimension tela = Toolkit.getDefaultToolkit().getScreenSize();
    public final ClienteDao dao;
    public final ClienteTableModel tabela;
    Cliente cliente = new Cliente();

    public GuiCadastroClientes(ClienteDao dao, ClienteTableModel tabela) {
        this.dao = dao;
        this.tabela = tabela;
        initComponents();
        definirEventos();
    ...
    public void editar(int id) {
        ...
        try {
            ...
            tfCnpjCpf.setText(cliente.getCpfcnpj());
            ...
            tfFoneResid.setText(cliente.getFoneResidencial());
            tfNumero.setText(cliente.getNumero());
            tfComplemento.setText(cliente.getComplemento());
            tfFoneComercial.setText(cliente.getFoneComercial());
            tfBairro.setText(cliente.getBairro());
            tfCelular.setText(cliente.getFoneCelular());
            cbUF.setSelectedItem(cliente.getUf());
            tfMunicipio.setText(cliente.getMunicipio());
            tfFax.setText(cliente.getFoneFax());
            cbPais.setSelectedItem(cliente.getPais());
            tfEmail.setText(cliente.getEmail());
            tfObs.setText(cliente.getObservacoes());
            cbAtivo.setSelected(Boolean.parseBoolean(cliente.getAtivo()));
            verificaAtivo();
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(GuiCadastroClientes.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        cbPais.setNextFocusableComponent(tfEmail);
        ...
        tfEmail.setNextFocusableComponent(tfObs);
    ...
    private void btCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancelarActionPerformed
        GuiCadastroClientes.this.dispose();
    }//GEN-LAST:event_btCancelarActionPerformed

    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        if ("".equals(tfCodigo.getText())) {
            cliente.setCpfcnpj(tfCnpjCpf.getText());
            ...
            cliente.setFoneResidencial(tfFoneResid.getText());
            cliente.setNumero(tfNumero.getText());
            cliente.setComplemento(tfComplemento.getText());
            cliente.setFoneComercial(tfFoneComercial.getText());
            cliente.setBairro(tfBairro.getText());
            cliente.setFoneCelular(tfCelular.getText());
            cliente.setUf((String) cbUF.getSelectedItem());
            cliente.setMunicipio(tfMunicipio.getText());
            cliente.setFoneFax(tfFax.getText());
            cliente.setPais((String) cbPais.getSelectedItem());
            cliente.setEmail(tfEmail.getText());
            cliente.setObservacoes(tfObs.getText());
            cliente.setAtivo(String.valueOf(cbAtivo.isSelected()));
            verificaAtivo();
            Date hoje = new Date();
            cliente.setDataCadastro(hoje);
            try {
                dao.adicionaCliente(cliente);
                JOptionPane.showMessageDialog(this, "Cliente adicionado com sucesso", "Salvo", JOptionPane.INFORMATION_MESSAGE);
                tfCodigo.setText(String.valueOf(cliente.getId()));
                tabela.adicionaCliente(cliente);
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(this, "Não foi possivel adicionar o cliente." + ex, "Erro", JOptionPane.ERROR_MESSAGE);
            ...
            try {
                ...
                tabela.editaCliente(dao.getTodosClientes());
            } catch (SQLException ex) {
    ...
    private void btAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAnteriorActionPerformed
        if (!"".equals(tfCodigo.getText())) {
            ...
            if (novoCodigo > 0) {
                try {
                    cliente = dao.getCliente(novoCodigo);
                    tfCnpjCpf.setText(cliente.getCpfcnpj());
                    tfCodigo.setText(String.valueOf(cliente.getId()));
                    tfNome.setText(cliente.getNome());
                    tfContato.setText(cliente.getContato());
                    ...
                    JOptionPane.showMessageDialog(this, "Não foi possivel encontrar o cliente." + ex, "Erro", JOptionPane.ERROR_MESSAGE);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(GuiCadastroClientes.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private void btProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btProximoActionPerformed
        ...
        if (!"".equals(tfCodigo.getText())) {
            ...
            novoCodigo = (Integer.parseInt(tfCodigo.getText()) + 1);
            try {
                quantidadeDeClientes = dao.getTodosClientes().size();
            } catch (SQLException ex) {
            ...
            if (novoCodigo <= quantidadeDeClientes) {
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Não foi possivel localizar o cliente." + ex, "Erro", JOptionPane.ERROR_MESSAGE);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(GuiCadastroClientes.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
