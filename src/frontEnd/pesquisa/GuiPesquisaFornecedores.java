...
public class GuiPesquisaFornecedores extends JDialog {
    
    public final FornecedorDao dao;
    public final FornecedorTableModel tabela;
    
    public GuiPesquisaFornecedores(FornecedorDao dao, FornecedorTableModel tabela) {
        this.dao = dao;
        this.tabela = tabela;
        nimbus();
        initComponents();
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        ...
        try {
            tabela.editaFornecedor(dao.getFornecedorIniciandoCom(nomeEditado));
            GuiPesquisaFornecedores.this.dispose();
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(GuiPesquisaFornecedores.class.getName()).log(Level.SEVERE, null, ex);
        }
