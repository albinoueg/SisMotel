...
public class GuiPesquisaClientes extends JDialog {
    
    public final ClienteDao dao;
    public final ClienteTableModel tabela;
    
    public GuiPesquisaClientes(ClienteDao dao, ClienteTableModel tabela) {
        this.dao = dao;
        this.tabela = tabela;
        nimbus();
        initComponents();
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        ...
        try {
            tabela.editaCliente(dao.getClientesIniciandoCom(nomeEditado));
            GuiPesquisaClientes.this.dispose();
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(GuiPesquisaClientes.class.getName()).log(Level.SEVERE, null, ex);
        }
