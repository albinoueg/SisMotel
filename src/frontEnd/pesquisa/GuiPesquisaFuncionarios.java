...
public class GuiPesquisaFuncionarios extends JDialog {
    
    public final FuncionarioDao dao;
    public final FuncionarioTableModel tabela;
    
    public GuiPesquisaFuncionarios(FuncionarioDao dao, FuncionarioTableModel tabela) {
        this.dao = dao;
        this.tabela = tabela;
        nimbus();
        initComponents();
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        ...
        try {
            tabela.editaFuncionario(dao.getFuncionariosIniciandoCom(nomeEditado));
            GuiPesquisaFuncionarios.this.dispose();
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(GuiPesquisaFuncionarios.class.getName()).log(Level.SEVERE, null, ex);
        }
